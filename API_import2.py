    ...
    class Elexon_query():
        ...
        def Get_Data(self, ID, start_date: str = None, end_date: str = None, max_days = 7,
            ...
            def Update_URL(URL: str, start_date: str = None, end_date: str = None,
                           ...
                           last_revision_only: bool = False, profile_only: bool = False) -> str:
                
                if start_date != None:
                    URL = URL + f"&{API_from_joiner}={str(start_date_temp)}"
                if end_date != None:
                    URL = URL + f"&{API_to_joiner}={str(end_date_temp)}"
                if fuel_types != None:
                    for i in fuel_types:
                        URL = URL + f"&fuelType={i.upper()}"
                if REMIT == True:
                    URL = URL + f"&lastestRevisionOnly={str(last_revision_only).lower()}"
            ...
            if date_diff >= max_days:
                ...
                while start_date_temp <= (end_date_dt - relativedelta(days = max_days)).date():
                    ...
                    URL_string_temp = Update_URL(URL = URL_string, start_date = start_date_temp,
                                                 ...
                                                 last_revision_only = last_revision_only, 
                    ...
                    if REMIT == True:
                        URL_string_temp = URL_string_temp + f"lastestRevisionOnly="
        ...
        def REMIT(self, start_date: str, end_date: str):
            
            df = Data_Import().Elexon_query().Get_Data(ID = "remit/list/by-event", start_date = start_date,
