...
trainid = rnd.choice(tot_sequences, replace = False, size = int(0.8*tot_sequences))
validid = [i for i in list(range(tot_sequences)) if i not in trainid]

print(set(trainid).intersection(set(validid)))
