...
class Data_Import:
    ...
    class Elexon_query():
        ...
        def REMIT(self, start_date: str, end_date: str, only_last_revision: bool = True):
            ...
            REMIT = REMIT.drop_duplicates(subset = ["BMU ID", "Fuel type", "Normal MW", "Available MW", "Unavailable MW"], 
                                          keep = "first")
            ...
            raise TypeError("The times in Feb-24 for DIDCB6 have completely disappeared when I've added the shift line in??")
            sys.exit()
