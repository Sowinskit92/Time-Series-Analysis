...
class Data_Import:
    ...
    class Elexon_query():
        ...
        def Get_Data(self, ID, start_date: str = None, end_date: str = None, max_days = 7,
                     ...
                     REMIT_MRID = None, REMIT_IDs = None, TEST: bool = False):
            ...
            def Elexon_Data_Query(URL: str, start_date: str = None, end_date: str = None,
                           ...
                           REMIT_MRID = None, REMIT_IDs: list = None, TEST: bool = False):
                ...
                def Update_URL(URL: str, start_date: str = None, end_date: str = None,
                               ...
                               REMIT_MRID: str = None, REMIT_IDs: list = None, TEST: bool = False) -> str:
                ...
                URL_string = Update_URL(URL = URL, start_date = start_date, end_date = end_date,
                                        ...
                                        REMIT_MRID = REMIT_MRID, TEST = TEST)
            ...
            elif isinstance(REMIT_MRID, list) or isinstance(REMIT_MRID, str):
                
                if isinstance(REMIT_MRID, list):
                    for i, j in enumerate(REMIT_MRID):
                        print(f"Collecting MRID results: {i/len(REMIT_MRID):.4f}%")
                        if i == 0:
                            df = Elexon_Data_Query(URL = URL_string, REMIT = REMIT, 
                                                    only_last_revision = only_last_revision, 
                                                    profile_only = profile_only,
                                                    REMIT_MRID = j, TEST = TEST)
                        else:
                            df_temp = Elexon_Data_Query(URL = URL_string, REMIT = REMIT, 
                                                        only_last_revision = only_last_revision, 
                                                        profile_only = profile_only,
        ...
        def REMIT(self, start_date: str, end_date: str, only_last_revision: bool = True,
            ...
            REMIT_MRIDs = Data_Import().Elexon_query().Get_Data(ID = "remit/list/by-event", start_date = start_date,
                                                              ...
                                                              only_last_revision = only_last_revision,
                                                              profile_only = profile_only)
            print(REMIT_MRIDs.columns)
            
            #REMIT_IDs = REMIT_IDs.rename(columns = Data_Import().column_renames)
            
            REMIT_MRIDs = REMIT_MRIDs["mrid"].unique().tolist()[:10]
...
if __name__ == "__main__":
    ...
    x = Data_Import().Elexon_query().REMIT("2024-12-01", "2024-12-04")
